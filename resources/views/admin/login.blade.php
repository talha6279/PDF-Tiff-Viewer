                ...
                <div class="col-sm-8 col-md-6 col-xl-9">
                  ...
                  <form  method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" name="email" value="{{ old('email') }}" placeholder="talhachander50@gmail.com" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                      @error('email')
                    ...
                    <div class="mb-4">
                      ...
                      <input type="password" name="password" placeholder="Min. 6 characters" class="form-control" id="exampleInputPassword1">
                      @error('password')
                        <div class="text-danger">{{ $message }}</div>
                      @enderror
                    </div>
