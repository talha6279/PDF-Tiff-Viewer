          ...
          <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('picture.add')}}" aria-expanded="false">
                  <span>
              ...
              <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('picture.show')}}" aria-expanded="false">
                  <span>
                    <i class="ti ti-aperture"></i>
                  </span>
                  <span class="hide-menu">All Pictures</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('picture.trashshow')}}" aria-expanded="false">
                  <span>
                    <i class="ti ti-aperture"></i>
                  </span>
                  <span class="hide-menu">Trashed Pictures</span>
                </a>
              </li>
